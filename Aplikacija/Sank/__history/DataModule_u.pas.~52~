...
type
  ...
  public
  constructor Create(AWorkerID: Integer);
...
constructor TWorkerTables.Create(AWorkerID: Integer);
begin
  inherited Create;
  FWorkerID := AWorkerID;
  FTableNumbers := TList<Integer>.Create;
end;

destructor TWorkerTables.Destroy;
begin
  FTableNumbers.Free;
  inherited Destroy;
end;
...
Tables := TList<Integer>.Create;
  ...
  Assignment := TWorkerTables.Create(WorkerID);
for i in Tables do
  Assignment.TableNumbers.Add(i);
