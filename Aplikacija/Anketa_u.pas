...
var
  RowValues: array[0..4] of Integer;
  i, j, idx: Integer;
  rb: TRadioButton;
  testID: Integer;
begin
  ...
  begin
    ...
    ParamByName('kiselost').AsInteger := RowValues[0];
    ParamByName('slatkoca').AsInteger := RowValues[1];
    ParamByName('jacina').AsInteger := RowValues[2];
    ParamByName('osvezavajuce').AsInteger := RowValues[3];
    ParamByName('ukupno').AsInteger := RowValues[4];
    ExecSQL;
  end;
