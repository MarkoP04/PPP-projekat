...
uses
  ...
  FireDAC.Comp.Client, Dodaj_ideju, Prototipi, FMX.Objects, Dodaj_prototip, Recepti;
...
begin
  ...
  Form1.FDQueryAction.SQL.Text :=
    'DELETE FROM Ideje WHERE ideja_id = :pIdeja';

  Form1.FDQueryAction.ParamByName('pIdeja').AsInteger := IdejaID;
