...
begin
  ...
  Form1.FDQueryAction.SQL.Text :=
    'INSERT INTO Recepti (prototip_id, ime, recept, cena) VALUES (:pID, :pIme, :pRecept, :pCena)';

  Form1.FDQueryAction.ParamByName('pId').AsInteger := PrototipID;
  Form1.FDQueryAction.ParamByName('pIme').AsString := Edit1.Text;
  Form1.FDQueryAction.ParamByName('pCena').AsFloat := StrToFloat(Edit2.Text);
  Form1.FDQueryAction.ParamByName('pRecept').AsString := recept;
...
begin
  ...
  Form1.FDQuery1.SQL.Text :=
    'SELECT ime, prototip FROM Prototipi WHERE prototip_id = :pID';
  Form1.FDQuery1.ParamByName('pID').AsInteger := PrototipID;
  Form1.FDQuery1.Open;

  Label6.Text := Form1.FDQuery1.FieldByName('ime').AsString;
  recept := Form1.FDQuery1.FieldByName('prototip').AsString;
end;
